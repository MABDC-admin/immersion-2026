    ...
    <Sidebar className="border-r-0" collapsible="icon">
      <SidebarHeader className="p-4">
        <Link to="/" className="flex items-center gap-2">
          ...
          {!collapsed && (
            <span className="text-xl font-bold text-sidebar-foreground">LOGO</span>
          )}
        </Link>
      </SidebarHeader>
      ...
      <SidebarFooter className="p-4 border-t border-sidebar-border">
        ...
        {!collapsed && (
          <Link
            to="/help"
            className="flex items-center gap-2 mt-4 text-sm text-sidebar-foreground/70 hover:text-sidebar-foreground"
          >
