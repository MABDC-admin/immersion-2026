  ...
  return (
    <MainLayout>
      <div className="space-y-6 animate-fade-in max-w-full overflow-x-hidden p-1">
        {showSupervisorTabs ? (
          /* ===== SUPERVISOR VIEW: No profile card, no tabs, just interns list ===== */
          <div className="space-y-6">
            <div className="flex items-center justify-between gap-4">
              <div>
                <h1 className="text-2xl font-bold text-foreground">My Interns</h1>
                <p className="text-sm text-muted-foreground">Manage and evaluate your assigned interns</p>
              </div>
            ...
            {evaluations.length > 0 && (
              <Card className="border-l-4 border-l-primary shadow-sm">
                <CardHeader className="pb-3">
                  <CardTitle className="text-lg font-bold">Recent Evaluations</CardTitle>
                </CardHeader>
          ...
          /* ===== REGULAR EMPLOYEE VIEW: Profile card + tabs ===== */
          <>
            {/* Header Actions */}
            <div className="flex items-center justify-between gap-4">
              <Button
